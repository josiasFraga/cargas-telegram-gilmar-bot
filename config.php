...
return [
    ...
    'api_key'      => '5589825223:AAHPCCbKSdU3SyxyhN2W0smZwKDppUAHNMg',
    'bot_username' => 'CargasCatcherBot', // Without "@"

    // [Manager Only] Secret key required to access the webhook
    'secret'       => '239523otk2kj523',

    // When using the getUpdates method, this can be commented out
    'webhook'      => [
        'url' => 'https://cargas.bot.gilmar.telegram.zapshop.com.br/teste_hook.php',
